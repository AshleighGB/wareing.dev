...
<head>
  ...
  <title>404 &raquo Joshua Wareing</title>
...
<main style="background:#efbe66 url('/images/topo_bg.png'); background-size: 65%; ">
  ...
  <div id="four_oh_four">
      ...
      <p> I'm. So. Sorry. The page you're looking for seems to be missing. If this page is supposed to exist, file a <a href="/report">Report</a>. if you ended up here accidentally, you can <a href="/">go home</a>.</p>
    </div>
  </div>
</main>
