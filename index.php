...
<div id="front_page">
  <div class="main">
    <h1 class="title"><span>Hello There.</span><br> My name is Joshua Wareing.<br> I'm a PHP, HTML & Rails developer.</h1>
    <p class="sub_title">Would you like to see my goals for the new year? <a href="/goals/2017">Click here</a></p>.
  </div>
  <nav id="front_page_nav" class="cf">

    <a href="/blog.cgi">
      <img src="/images/blog_icon.svg" alt="Blog">
      Blog
    </a>

    <a href="//notify.wareing.xyz/news.xml">
      <img src="/images/news_icon.svg" alt="News">
      News
    </a>

    <a href="/forms/say-hello" class="highlight">
      <img src="/images/say_hello_icon.svg" alt="Say Hello">
      Say Hello
    </a>
    <a href="/projects/home">
      <img src="/images/project_icon.svg" alt="Projects">
      Projects
    </a>
    <a href="/stuff/say-hello">
      <img src="/images/say_hello_icon.svg" alt="">
      Say Hello
    </a>
    <a href="/stuff/say-hello">
      <img src="/images/say_hello_icon.svg" alt="Say Hello">
