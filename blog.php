...
<head>
  ...
  <title>Blog &raquo Joshua Wareing</title>
...
<main style="background:#efbe66 url('/images/topo_bg.png'); background-size: 65%; ">
  ...
  <p class="date_and_category">Jan 1st, 2017 <span>&bullet;</span> <a href="/cat.cgi?name=Announcements" rel="category tag">Announcements</a>, <a href="/cat.cgi?name=Ramblings" rel="category tag">Ramblings</a></p>
				
	<h2 class="title"><a href="/viewpost.cgi?name=ShinyNewSiteDesign" title="Shiny New Site Design!">Shiny New Site Design!</a></h2>

	<p>Hey There! Welcome to my Shiny new website! There's a BUNCH of new features</p>
    ...
    <div class="cd-half-block">
      ...
      <nav>
        <ul class="cd-primary-nav">
          ...
          <li><a href="/blog">Blog <span>Thoughts &amp; Videos</span></a> <- Current Location</li>
        </ul>
      </nav>
    </div><!-- .cd-half-block -->
